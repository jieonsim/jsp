...
<div class="container">
  <form name="myform" method="post" action="${ctp}/MemberJoinOk.mem" class="was-validated">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="homePage" value="http://" value="${vo.homePage}" id="homePage"/>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
		취미 : &nbsp;
		<c:set var="varHobbies" value="${fn:split('등산/낚시/수영/독서/영화감상/바둑/축구/기타','/')}"></c:set>
