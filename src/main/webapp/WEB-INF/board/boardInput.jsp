...
<div class="container mt-5">
	<h2 class="text-center" style="letter-spacing: 10px">게시판 글쓰기</h2>
	<form name="myform" method="post" action="BoardInputOk.bo">
		<table class="table table-bordered">
			...
			<tr>
				<th>글내용</th>
				<td><textarea name="content" id="content" rows="6" required class="form-control"></textarea></td>
			</tr>
			<tr>
				<th>공개여부</th>
				<td>
			...
			<tr>
				<td colspan="2" class="text-center">
					...
					<input type="button" value="돌아가기" onclick="loaction.href='BoardList.bo';" class="btn btn-info"/>
				</td>
			</tr>
		</table>
