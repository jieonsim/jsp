...
<body>
	...
	<div class="container">
		<form name="myform" method="post" action="PdsInputOk.pds" enctype="multipart/form-data">
			...
			<div class="mb-2">
				내용 :
				<textarea rows="4" name="content" id="content" placeholder="자료의 상세내역을 입력하세요" class="form-control"></textarea>
			</div>
			<div class="mb-2">
				분류 :
			...
			<div class="mb-2">
				공개여부 :
				<input type="radio" name="openSw" value="공개" onclick="pwdCheck1()" checked class="mr-3" />
				공개
				<input type="radio" name="openSw" value="비공개" onclick="pwdCheck2()" class="mr-3" />
				비공개
				<div id="pwdDemo" style="display: none">
