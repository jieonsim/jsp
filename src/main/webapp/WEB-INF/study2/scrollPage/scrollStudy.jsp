			...
			<div class="box">
				<div class="small-box">
					<span class="text-success">
						<b>박스 안에서 스크롤바를 '상/하/좌/우'로 이동해 보세요</b>
					</span>
				</div>
			</div>
		</div>
		<div class="text-danger text-center" id="disp">
			<strong> <span class="h">0</span> px / <span class="v">0</span> px
			</strong>
		</div>
		<hr />
		<div class="sampleBtn">
			...
			<div>
				<input type="button" value="x으로 +10px" class="btn btn-primary mb-2 btn4" />
				<input type="button" value="x으로 -10px" class="btn btn-outline-primary mb-2 btn5" />
			</div>
			<div>
				<input type="button" value="y으로 +10px" class="btn btn-primary mb-2 btn6" />
				<input type="button" value="y으로 -10px" class="btn btn-outline-primary mb-2 btn7" />
			</div>
		</div>
	</div>
	<p>
