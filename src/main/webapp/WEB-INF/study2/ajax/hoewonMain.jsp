		...
		<table class="table table-bordered">
			...
			<tr>
				<td colspan="2" class="text-center">
					...
					<input type="button" onclick="hUpdate()" value="회원수정" class="btn btn-info mr-2"/>
					<input type="button" onclick="location.href='hoewonList.st';" value="전체보기" class="btn btn-secondary"/>
				</td>
			</tr>
		</table>
	</form>
