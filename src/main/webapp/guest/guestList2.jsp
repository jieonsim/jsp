...
<div class="container">
  ...
  <br/>
	  ...
	  <div class="text-center">
		  ...
		  <c:if test="${curBlock > 0}">[<a href="${ctp}/GuestList?pag=${(curBlock-1)*blockSize + 1}&pageSize=${pageSize}">이전블럭</a>]</c:if>
		  ...
		  <c:if test="${curBlock < lastBlock}">[<a href="${ctp}/GuestList?pag=${(curBlock+1)*blockSize+1}&pageSize=${pageSize}">다음블럭</a>]</c:if>
