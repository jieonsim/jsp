				...
				<div class="carousel-container">
					<div class="row">
						...
						<div class="col-sm-4 d-flex justify-content-end">
							<a href="#" id="fullView"> <span
								style="font-size: 16px; color: black">전체보기<i
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item">
								...
								<div class="carousel-caption text-left">
									<p>@locallens</p>
									<h3>
										<b>이번 달에 꼭 가야할<br>서울 주변 감각적인 전시 8
										</b>
									</h3>
								</div>
							</div>
							<div class="carousel-item">
								...
								<div class="carousel-caption text-left">
									<p>@locallens</p>
									<h3>
										<b>이번 주말 데이트하기 좋은<br>용산 주변 공간 14
										</b>
									</h3>
								</div>
							</div>
				...
				<div class="carousel-container">
					...
					<div id="demo2" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item">
								<img src="../temp_project/images/8.jpeg" alt="New York">
								<div class="carousel-caption text-left">
									<p>@locallens</p>
									<h3>
										<b>이번 주말 데이트하기 좋은<br>용산 주변 공간 14
