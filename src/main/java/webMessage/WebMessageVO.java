...
public class WebMessageVO {
	...
	public String toString() {
		return "WebMessageVO [idx=" + idx + ", title=" + title + ", content=" + content + ", sendId=" + sendId + ", sendSw=" + sendSw + ", sendDate=" + sendDate
				+ ", receiveId=" + receiveId + ", receiveSw=" + receiveSw + ", receiveDate=" + receiveDate + ", hour_diff=" + hour_diff + "]";
	}
