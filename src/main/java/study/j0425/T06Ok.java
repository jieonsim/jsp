...
public class T06Ok extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// gender는 checked로 반드시 값이 하나 넘어오기 때문에 null 처리 안해도됨
		String[] hobbies = request.getParameterValues("hobby");
		// hobby가 여러개 들어올 수 있기 때문에 배열로 처리해야함
		String job = request.getParameter("job");
		// jsp에서 value=""로 주고 왔기 때문에 별도 null 처리 안함
		...
		System.out.println("다녀온 산 : " + mountain);
		...
		out.println("<p>다녀온 산 : "+ mountain +"</p>");
