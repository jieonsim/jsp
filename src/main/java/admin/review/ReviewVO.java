...
public class ReviewVO {
	...
	public String toString() {
		return "ReviewVO [idx=" + idx + ", part=" + part + ", partIdx=" + partIdx + ", mid=" + mid + ", nickName=" + nickName + ", star=" + star + ", content="
				+ content + ", rDate=" + rDate + ", replyIdx=" + replyIdx + ", replyMid=" + replyMid + ", replyNickName=" + replyNickName + ", replyRDate="
				+ replyRDate + ", replyContent=" + replyContent + "]";
	}
}
